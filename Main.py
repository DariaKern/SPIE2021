...
dict_organ_box_paths = get_dict_of_paths(GT_BB_PATH, ORGAN)  # load all paths to gt bbs of organ
check_if_all_files_are_complete(dict_scan_files, dict_gt_seg_files, dict_organ_box_paths)
...
crop_out_bbs(dict_scan_files, dict_organ_box_paths, save_path_cropped_scans)
crop_out_bbs(dict_gt_seg_files, dict_organ_box_paths, save_path_cropped_seg, ORGAN)
...
resample_files_reverse(save_path_results, save_path_rr, dict_organ_box_paths, dict_scan_files)

# put area of interest back into original position
crop_files_reverse(save_path_rr, save_path_rc, dict_organ_box_paths, dict_scan_files)
