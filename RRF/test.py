...
for file in os.scandir(GT_SEG_PATH):
    ...
    for organ in [150, 156, 157, 160, 170]:
        ...
        worldV = [worldOrig[0] + v[0] * worldSpacg[0],
                  worldOrig[0] + v[1] * worldSpacg[0],
                  worldOrig[1] + v[2] * worldSpacg[1],
                  worldOrig[1] + v[3] * worldSpacg[1],
                  worldOrig[2] + v[4] * worldSpacg[2],
                  worldOrig[2] + v[5] * worldSpacg[2]]
